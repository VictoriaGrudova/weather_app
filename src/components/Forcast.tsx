...
const Forcast = ({data}: Props): JSX.Element => {
    ...
    return(
        <div className="w-full md:max-w-[500px] py-4 md:py-4 md:px-10 lg:px-24 lg:h-auto bg-white bg-opacity-20 backdrop-blur-ls rounded drop-shadow-lg overflow-auto h-screen">
            <div className="mx-auto w-[300px]">
                ...
                <section className="flex overflow-x-scroll pointer-events-auto mt-4 pb-2 mb-5">
